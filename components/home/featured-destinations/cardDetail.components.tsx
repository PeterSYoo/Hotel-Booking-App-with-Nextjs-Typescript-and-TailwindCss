...
export const CardDetail = ({
  ...
  return (
    <div
      className="relative p-7 h-full bg-cover bg-center rounded-3xl"
    ...
    >
      ...
      <div className="flex flex-col justify-between h-full">
        <div className="rating-container flex">
          <div className="card-rating text-red-700 font-bold text-lg bg-white rounded-2xl py-[2px] px-5 ">
            {rating}
          </div>
        </div>
        <div className="card-title z-[2]">
          <span className={`font-bold text-white ${titleSize}`}>
            {location}
          </span>
          <div className="avatar-group flex flex-row justify-start items-center gap-x-3">
            <div className="avatar-image rounded-full w-7 h-7">
              <Image src={avatar} alt="avatar" width="28px" height="28px" />
            </div>
