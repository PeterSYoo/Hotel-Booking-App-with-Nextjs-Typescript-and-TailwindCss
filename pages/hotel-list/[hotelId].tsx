...
const tagsForDev = [
  "5.0", "Perfect", "Hotels", "Bulding", "Top Value", "Something"
]
    ...
    <>
      ...
      <div className="tags-review flex flex-col justify-start items-start gap-2 px-4">
        ...
        <div className="tags flex flex-row flex-wrap items-center gap-3">
          ...
          {tagsForDev.map((tag, i) => (
            <div key={i}>
              <div className="flex flex-row justify-center items-center py-1 px-3 rounded-md bg-[#d5e1d6] text-[#38b245]">{tag}</div>
            </div>
          ))}
        </div>
      ...
      <div className="title-line flex flex-col items-start gap-8 px-4">
        <div className="title flex flex-col items-start gap-5">
          <h2 className="font-medium text-4xl text-[#252525]">Exlcusive room in house</h2>
          <h3 className="font-medium text-2xl text-[#84878b]">Zuich, Switzerland</h3>
        </div>
      ...
      <div className="description-content flex flex-col items-start gap-2 px-4">
        <div className="row flex flex-row items-center gap-10">
          <div className="font-medium text-base text-[#145ce6]">Description</div>
        </div>
        ...
        <p>Arabian Park Hotel is a great choice for travellers looking for a 3 star hotel in Dubai. It is located in Bur Dubai. This Hotel stands out as one of the highly recom.2 kms), Al Wasl Indoor Stadium (1.2 kms), Dubai Mall (5.4 kms), Jumeirah Beach Park (9.6 kms) and Jumeirah Public Beach (15.8 kms).
</p>
      </div>
